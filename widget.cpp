...
//    ui->label_7->setText("Share by SMS");
    ...
    ui->plainTextEdit->setPlainText(ui->label_6->text().append(":\n").append(ui->textBrowser->toPlainText()).append("\n-Source: Health Assistant App"));
...
void Widget::on_pushButton_15_clicked()
{
    ...
    message.setSubject(QString("Information on ").append(ui->label_6->text()).append(" -generated by Health Assistant"));
